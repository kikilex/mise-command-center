...
## Agent 1: Dashboard (src/app/page.tsx)
...
## Agent 2: ChatWidget (src/components/ChatWidget.tsx)

### Thread List Text Size
...
## Agent 3: Spaces Detail (src/app/spaces/[id]/page.tsx)
...
### Remove confirm() for Member Removal
...
## Agent 4: Task Detail (src/components/TaskDetailModal.tsx)
...
### Inline Priority Editing (Read-Only Mode)
...
### Inline Due Date Editing (Read-Only Mode)
...
## Agent 5: Docs (src/app/docs/page.tsx + src/app/docs/[id]/page.tsx)
...
- No markdown preview — just a plain textarea
- After save, close modal and refresh list

### Doc Detail - Back Arrow Fix
...
## Agent 6: Calendar (src/app/calendar/page.tsx)
